...
<head>
  ...
  <title>Admin | Sıkça Sorulan Sorular</title>
       ...
       <!-- Default box -->
           <div class="card">
             <div class="card-header">
               ...
               <a class="btn  btn-info" href="{{route('admin_faq_add')}}">Faq Ekle</a>
               <br>
             ...
             <div class="card-body">
               <table id="example1" class="table table-bordered table-striped">
                 ...
                 <tr>
                   ...
                   <td>
                     <a href="{{route('admin_faq_delete', ['id' => $rs->id])}}" onclick="return confirm('Silmek istediğinize emin misiniz?')">
